...
const enabled = [{ label: "대시보드", href: "/dashboard" }, { label: "거래처 관리", href: "/clients" }, { label: "견적서 관리", href: "/quotations" }, { label: "거래명세서 관리", href: "/transaction-statements" }, { label: "프로젝트 비용", href: "/project-costs" }, { label: "입금 및 미수금", href: "/receivables" }] as const;
