...
const enabled = [{ label: "대시보드", href: "/dashboard" }, { label: "거래처 관리", href: "/clients" }, { label: "견적서 관리", href: "/quotations" }, { label: "프로젝트 비용", href: "/project-costs" }] as const;
const upcoming = ["명세서 관리", "프로젝트 관리", "입금 및 미수금", "승인 관리", "보고서", "사용자 관리", "시스템 설정", "감사 로그"];
