...
품목 마스터, 거래명세서 이외의 명세서 유형, 전자결재 워크플로, PDF/Excel 파일 다운로드, 증빙 파일 스토리지, 상세 RBAC 미들웨어와 E2E 테스트는 아직 구현되지 않았습니다. 주문서·발주서는 오더 단계의 외부 문서 링크와 메모로만 지원하며, 실제 증빙 업로드나 외부 회계·카드·은행·세금계산서 연동은 포함되지 않습니다.
