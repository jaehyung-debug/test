...
현재 거래처·품목·견적·명세·프로젝트·지출·입금 CRUD API/UI, 승인 워크플로, PDF/Excel, 파일 스토리지, 실제 대시보드 집계, 상세 RBAC 미들웨어, 통합/E2E 테스트는 아직 구현되지 않았습니다. 대시보드의 `—` 값은 이 사실을 명확히 표시하며 임시 업무 데이터는 사용하지 않습니다.
